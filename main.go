...
func main() {
	...
	r.GET("/login", func(c *gin.Context) {
		...
		if err != nil {
			c.String(http.StatusInternalServerError, "missing login")
			return
		}
	...
	r.GET("/register", func(c *gin.Context) {
		...
		if err != nil {
			c.String(http.StatusInternalServerError, "missing register")
			return
		}
		c.Data(http.StatusOK, "text/html; charset=utf-8", f)
	})
	...
	r.GET("/app", auth.AuthRequired(authRepo), func(c *gin.Context) {
		...
		if err != nil {
			c.String(http.StatusInternalServerError, "missing app")
			return
		}
		c.Data(http.StatusOK, "text/html; charset=utf-8", f)
	})
